...
<html lang="en">
	...
	<nav class="container">
		...
		<section id="main">
	    <a href="/blog/Snail/Index/save" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></a>
<div class="table-responsive">
	<table class="table table-striped">
		...
		<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="/blog/Snail/Index/modify/id/<?php echo ($article["id"]); ?>" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></a>
