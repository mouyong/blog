...
<div class="table-responsive">
	<table class="table table-striped">
		<tr>
			...
			<th class="col-md-5">文章内容</th>
			<th class="col-md-1">状态</th>
			<th class="col-md-2">操作</th>
		</tr>
		<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><tr>
			<td><?php echo ($article["title"]); ?></td>
			<td><?php echo ($article["type"]); ?></td>
			<td><?php echo ($article["label"]); ?></td>
			<td class="summary"><?php echo (stristr($article["article"], '</p>', true)); ?></td>
			<td>
			<?php switch($article["display"]): case "1": ?>显示<?php break;?>
				<?php case "0": ?><span class="none">隐藏</span><?php break; endswitch;?>
			</td>
			<td>
				<a href="/snail/Snail/<?php echo CONTROLLER_NAME ;?>/modify/id/<?php echo ($article["id"]); ?>" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
					<a href="/snail/Snail/<?php echo CONTROLLER_NAME ;?>/del/id/<?php echo ($article["id"]); ?>" class="btn btn-danger">Yes</a>
