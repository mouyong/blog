...
<div id="content">
    <a href="/blog/Snail/Label/save">添加标签</a>
	<table>
		<tr>
			<th>标签云</th>
			<th>标签</th>
		...
		<?php if(is_array($label)): $i = 0; $__LIST__ = $label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$label): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="/blog/Snail/Label/modify/id/<?php echo ($label["id"]); ?>">修改</a>
				<a href="/blog/Snail/Label/del/id/<?php echo ($label["id"]); ?>" onclick="return confirm('真的要删除吗?此操作不可恢复!')">删除</a>
			</td>
