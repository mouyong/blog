...
<html lang="en">
	...
	<nav class="container">
		...
		<section id="main">
			<a href="/snail/Snail/Label/save" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></a>
<div class="table-responsive">
	<table class="table table-striped">
		...
		<?php if(is_array($label)): $i = 0; $__LIST__ = $label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$label): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="/snail/Snail/Label/modify/id/<?php echo ($label["id"]); ?>" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></a>
