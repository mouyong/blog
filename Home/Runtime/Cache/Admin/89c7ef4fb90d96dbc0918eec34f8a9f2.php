...
<html lang="en">
	...
	<nav class="container">
		...
		<section id="main">
			<a href="/blog/Snail/Flink/save" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></a>
<div class="table-responsive">
	<table class="table table-striped">
		...
		<?php if(is_array($flink)): $i = 0; $__LIST__ = $flink;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$flink): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="/blog/Snail/Flink/modify/id/<?php echo ($flink["id"]); ?>" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></a>
