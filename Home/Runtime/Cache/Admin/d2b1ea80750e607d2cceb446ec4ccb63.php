...
<html lang="en">
    ...
    <form action="/blog/Snail/About/update" method="post" class="container">
    	<table class="table">
    		<caption>Modified an About</caption>
    		<input type="hidden" name="id" value="<?php echo ($id); ?>" />
    		<tr>
    			<td>
    				<input type="text" name="key" value="<?php echo ($about["key"]); ?>" />
    			</td>
    		</tr>
    		<tr>
    			<td class="col-xs-12">
    				<script id="ueditor" name="value" type="text/plain"><?php echo ($about["value"]); ?></script>
...
<script type="text/javascript">
    var ue = UE.getEditor('ueditor');
    		...
    		<tr>
    			<td>
    				<?php switch($about["display"]): case "1": ?><input type="radio" id="block" name="display" value="1" checked /><label for="block">显示</label>
