...
<div class="table-responsive">
	<table class="table table-striped">
		...
		<?php if(is_array($navls)): $i = 0; $__LIST__ = $navls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$navls): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="/snail/Snail/<?php echo CONTROLLER_NAME ;?>/modify/id/<?php echo ($nav["id"]); ?>" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
					<a href="/snail/Snail/<?php echo CONTROLLER_NAME ;?>/del/id/<?php echo ($nav["id"]); ?>" class="btn btn-danger">Yes</a>
